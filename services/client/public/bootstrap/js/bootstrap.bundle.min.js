      ...
      modifiers: {
        ...
        computeStyle: {
          ...
          fn: function (t, e) {
            ...
            if (
              ((m =
                'bottom' === h ? ('HTML' === a.nodeName ? -a.clientHeight + u.bottom : -l.height + u.bottom) : u.top),
      ...
      return (
        ...
        (n._getConfig = function (t) {
          ...
          return (
            ...
            'number' ==
              typeof (t = s(s(s({}, this.constructor.Default), n), 'object' == typeof t && t ? t : {})).delay &&
      ...
      return (
        (n.show = function () {
          ...
          if (
            ...
            if (
              (i && e(i).trigger(a), e(this._element).trigger(c), !c.isDefaultPrevented() && !a.isDefaultPrevented())
            ) {
